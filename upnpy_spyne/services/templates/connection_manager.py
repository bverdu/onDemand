...
from upnpy.services import Service, register_action, \
...
class ConnectionManagerService(Service):
    ...
    source_protocol_info = EventProperty(
        'SourceProtocolInfo',
        ns='urn:schemas-upnp-org:metadata-1-0/RCS/')
    sink_protocol_info = EventProperty(
        'SinkProtocolInfo',
        ns='urn:schemas-upnp-org:metadata-1-0/RCS/')
    current_connection_ids = EventProperty(
